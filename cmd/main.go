...
import (
	...
	webappv1 "github.com/mahdibouaziz/guestbook-kubebuilder/api/v1"
	"github.com/mahdibouaziz/guestbook-kubebuilder/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "2c993990.my.domain",
